...
ConceptDef(ind_read,CL I,CL V=iter_value_t<I>,CL R=iter_reference_t<I>,CL RR=iter_rvalue_reference_t<I>)(const I i)(
    Cret(same_as,*i)(R)
    Cret(same_as,Rg iter_move(i))(RR)
    Creq(common_reference_with<R&&,V&>)
    Creq(common_reference_with<R&&,RR&&>)
    Creq(common_reference_with<RR&&,const V&>)
);
template<CL I> concept indirectly_readable=ConceptRef(ind_read,remove_cvref_t<I>);
//[default.sentinel]
